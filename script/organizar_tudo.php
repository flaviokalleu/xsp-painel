...
$db_name = getenv('DB_NAME') ?: 'xsp_panel'; // Suas credenciais
$db_user = getenv('DB_USER') ?: 'xsp'; // Suas credenciais
$db_pass = getenv('DB_PASS') ?: '';      // Suas credenciais
$charset = 'utf8mb4';
...
<head>
    ...
    <style>
        body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; background-color: #ffffff; color: #333; margin: 0; padding: 20px; }
